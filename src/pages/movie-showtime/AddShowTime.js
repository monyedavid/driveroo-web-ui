...
import { addShowTIme } from "../../initializers";
...
class AddShowTime extends Component {
    ...
    onSubmit = e => {
        ...
        // generate icket type object array  {class : price}

        console.log(stateObjectCopy, "STATEOFOBJECT");
        // sold: '', // generate from ????
        ...
        // showTimeObject['date'] = mongodateFormatter(
        //   showTimeObject.date,
        //   showTimeObject.time,
        // );
    };
                                              ...
                                              <Col sm={8}>
                                                  ...
                                                  >
                                                      {this.state
                                                          .cinema_location
                                                          .length > 1 ? (
                                                          this.state.cinema_location.map(
                                                              (obj, i) => {
                                                                  return (
                                                                      <option
                                                                          key={
